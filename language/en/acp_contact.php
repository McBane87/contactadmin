...
$lang = array_merge($lang, array(
	...
	'CONTACT_ATTACHMENTS_EXPLAIN'		=> 'If set attachments will be allowed in posting to the forum and private messages.<br>The extensions allowed are the same as the board configuration.<br><span style="color:red;">Does not apply for contact method via “EMail” and “EMail-Board”.</span>',
	...
	'CONTACT_FOUNDER_EXPLAIN'			=> 'If set only the Founder of the Forum will get Email or PM notifications.<span style="color:red;">Does not apply for contact method via “EMail-Board”.</span>',
	...
	'CONTACT_METHOD_EXPLAIN'			=> 'How do you want users to be able to make contact.<br>“EMail” sends an EMail to all admin users of this board.<br>“EMail-Board” uses the mail specified in “Client Communication -> Email settings -> Contact email address”<br><span style="color:red;">If set as “EMail” or “EMail-Board” then attachments do not apply.</span>',
